package com.deymosko.d_serverutils;

import com.deymosko.command.TpsCommand;
...
@Mod(D_serverurils.MODID)
public class D_serverurils {
    ...
    public static class ModCommands
    {
        ...
        {
            event.getDispatcher().register(TpsCommand.register());
        }
    }
